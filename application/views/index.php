  ...
  <div class="container-fluid px-0">
    ...
    <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
      <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
          <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="#home" aria-expanded="false">Beranda
            <img src="./assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1">
</a>

</li>
        <li class="nav-item dropdown dropdown-hover mx-2">
          <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="#about" aria-expanded="false"> Tentang Kami
            <img src="./assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1"/>
          </a>
</li>  
    <li class="nav-item dropdown dropdown-hover mx-2">
...
<section class="pt-3 pb-4" id="header">
    <div class="container">
      <div class="row">
  ...
  <div class="p-3 text-center">
    <div style="display: flex; justify-content: center; margin-bottom: 8px;">
      ...
      <div class="p-3 text-center">
        <div style="display: flex; justify-content: center; margin-bottom: 8px;">
       <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><g fill="none"><path fill="url(#SVGBvfmnbLB)" d="M21.803 6.086c.899-1.821 3.495-1.821 4.394 0l4.852 9.832l10.85 1.576c2.01.293 2.813 2.762 1.358 4.18l-7.85 7.653l1.853 10.806c.343 2.001-1.758 3.528-3.555 2.583L24 37.614l-9.705 5.102c-1.797.945-3.898-.582-3.555-2.583l1.854-10.806l-7.851-7.654c-1.455-1.417-.652-3.886 1.357-4.178l10.85-1.577z"/><defs><linearGradient id="SVGBvfmnbLB" x1="43.995" x2="2.879" y1="43.856" y2="5.054" gradientUnits="userSpaceOnUse"><stop stop-color="#ff6f47"/><stop offset="1" stop-color="#ffcd0f"/></linearGradient></defs></g></svg>
    </div>
        <h1 class="text-gradient text-dark"><span id="state1" countTo="250">7</span> Tahun</h1>
        <h5 class="mt-3">Berpengalaman Melayani Customer</h5>
    </div>
          </div>
           <div class="col-md-4 position-relative">
  <div class="p-3 text-center">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 ms-auto">
        ...
        <div class="row justify-content-start mt-5">
          <div class="col-md-6 mt-3">
            <div class="info">
              <div class="icon icon-sm">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" d="M13 16.5a11 11 0 0 0 4.041 3.93l1.459.82v.25h-13v-.25l1.459-.82A11 11 0 0 0 11 16.5m-9.5-3h21m0-11h-21v14h21z" stroke-width="1"/></svg>
      ...
      <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
          <div class="card card-background card-background-mask-dark tilt" data-tilt>
            <div class="full-background" style="background-image: url('/assets/img/dummy1.png')"></div>
